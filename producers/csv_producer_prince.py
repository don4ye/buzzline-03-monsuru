"""
csv_producer_prince.py

Stream personal health data (steps, heart rate, calories burned, etc.) to a Kafka topic.
...
def get_kafka_topic() -> str:
    ...
    topic = os.getenv("HEALTH_TOPIC", "health_data_topic")
...
def get_message_interval() -> int:
    ...
    interval = int(os.getenv("HEALTH_INTERVAL_SECONDS", 1))
...
DATA_FILE = DATA_FOLDER.joinpath("health_data.csv")
        ...
        try:
            ...
            with open(DATA_FILE, "r") as csv_file:
                ...
                for row in csv_reader:
                    ...
                    if not all(field in row for field in ["steps", "heart_rate", "calories_burned", "sleep_hours", "hydration_liters"]):
